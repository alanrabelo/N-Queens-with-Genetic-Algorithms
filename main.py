...
def fitness(individual):
    ...
    sumDiag1 = (sum(value > 1 for value in diagonals(arrayFromIndividual)))
    sumDiag2 = (sum(value > 1 for value in diagonals(arrayFromIndividual, invert=True)))
...
top10 = tools.selWorst(population, k=10)
